...
local mode_map = {
    ...
    n      = {icons.normal    .. "  NORMAL  ", colors.green},
    no     = {icons.normal    .. "  NORMAL  ", colors.green},
    i      = {icons.insert    .. "  INSERT  ", colors.crimsonRed2},
    ic     = {icons.insert    .. "  INSERT  ", colors.crimsonRed2},
    c      = {icons.command   .. "  COMMAND ", colors.orange},
    ce     = {icons.command   .. "  COMMAND ", colors.orange},
    cv     = {icons.command   .. "  COMMAND ", colors.orange},
    v      = {icons.visual    .. "  VISUAL  ", colors.magenta},
    V      = {icons.visual    .. "  VISUAL  ", colors.magenta},
